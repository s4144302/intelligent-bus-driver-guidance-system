...
public class DriverServiceTest {
    ...
    // Clear the test file and set up fresh repo and service before each test.
    @BeforeEach
    public void setUp() throws IOException {
        ...
        repo = new DriverRepository("data/test-drivers.txt");
    ...
    // D2 Test 4: Edge case - address using wrong separator produces one part instead of five and is rejected.
    @Test
